...
//        return _dataSource;
    ...
    public void registerExtensionFilter(AbstractExtensionCorreationFilter filter) {
    	_server.registerExtensionCorrelationFilter(filter);
    }

    public void unregisterExtensionFilter(AbstractExtensionCorreationFilter filter) {
    	_server.unregisterExtensionBundle(filter.getNamespaceURI());
    }
