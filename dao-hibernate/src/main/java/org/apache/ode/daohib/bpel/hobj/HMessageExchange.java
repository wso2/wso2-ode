...
public class HMessageExchange extends HObject {
    ...
    private Collection<HAttachment> attachments = new ArrayList<HAttachment>();
    ...
    public void setAttachments(Collection<HAttachment> attachments) {
        this.attachments = attachments;
    }
    /**
     * @hibernate.bag lazy="true" inverse="true"
     * @hibernate.collection-key column="MESSAGE_EXCHANGE_ID" foreign-key="none"
     * @hibernate.collection-one-to-many class="org.apache.ode.daohib.bpel.hobj.HAttachment"
     */
    public Collection<HAttachment> getAttachments() {
