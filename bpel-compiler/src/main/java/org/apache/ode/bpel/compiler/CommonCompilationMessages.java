...
public class CommonCompilationMessages extends CompilationMessageBundle {
    ...
    /** Type could not resolved for Property "{0}".*/
    public CompilationMessage errPropertyTypeNotResolved(String name, String nscExMsg) {
        return this.formatCompilationMessage("Type could not resolved for Property \"{0}\". Reason: {1}", name, nscExMsg);
    }
